...
class InceptionTimeEnsembleLate(NNModel):

    def __init__(self, dataset_name, train_dataset, test_dataset, metadata, model_name = 'InceptionTimeEnsembleLate', random_state=42, device='cuda', is_multimodal=True) -> None:
